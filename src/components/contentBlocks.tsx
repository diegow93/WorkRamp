...
export function Text(props: { contentBlockText: ContentBlockText }) {
  return (
    <section className="flex h-auto w-full flex-col rounded border border-gray-300 bg-white first:border-b">
      ...
      <div className="w-full flex-auto p-3">
        ...
        >
          {props.contentBlockText.content}
        </textarea>
      </div>
    </section>
  );
...
export function TextAnswer(props: { contentBlockAnswer: ContentBlockAnswer }) {
